...
// APP_FILES), which has no require(). resolve-ink.js and line-style.js are
// concatenated after this file and read the table off window there.
(function () {
    var COLORS = {
